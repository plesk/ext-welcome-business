...
class IndexController extends pm_Controller_Action
{
    ...
    {
        $step = Modules_WelcomeBusiness_Helper::getNextStep();
        pm_Settings::set('welcome-step', $step);

        $this->redirect(Modules_WelcomeBusiness_Helper::getReturnUrl());
    }
    ...
    public function installAction()
    {
        if (!empty($_GET['extension'])) {
            ...
            $result = Modules_WelcomeBusiness_Helper::installExtension($extension);
